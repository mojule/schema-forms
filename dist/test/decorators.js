...
describe('schema-forms', () => {
    describe('decorators', () => {
        describe('fieldset', () => {
            it('decorates', () => {
                const arrayTemplate = (0, __1.ArrayTemplate)(dom_1.document);
                const fieldsetArrayTemplate = (0, __1.FieldsetDecorator)(dom_1.document, arrayTemplate);
            ...
            it('decorates without legend', () => {
                const arrayTemplate = (0, __1.ArrayTemplate)(dom_1.document);
                const fieldsetArrayTemplate = (0, __1.FieldsetDecorator)(dom_1.document, arrayTemplate, false);
                const container = fieldsetArrayTemplate({ title: 'Foo' });
                assert.strictEqual(container.localName, 'fieldset');
                const legend = container.querySelector('legend');
        ...
        describe('label', () => {
            it('decorates', () => {
                const labelDecorator = (0, __1.LabelDecorator)(dom_1.document, (0, __1.StringTemplate)(dom_1.document));
            ...
            it('isSuffix true', () => {
                const labelDecorator = (0, __1.LabelDecorator)(dom_1.document, (0, __1.StringTemplate)(dom_1.document), true);
                const editor = labelDecorator();
                assert.strictEqual(editor.localName, 'label');
        ...
        describe('format', () => {
            it('template from format', () => {
                const stringTemplates = {
                    ...
                    multiline: (0, __1.StringTemplate)(dom_1.document, true)
                };
                const formatDecorator = (0, __1.FormatDecorator)(dom_1.document, stringTemplates);
            ...
            it('finds input when decorated with wrapper element', () => {
                const stringTemplates = {
                    string: (0, __1.LabelDecorator)(dom_1.document, (0, __1.StringTemplate)(dom_1.document))
                };
                const formatDecorator = (0, __1.FormatDecorator)(dom_1.document, stringTemplates);
                const el = formatDecorator({ format: 'color' });
            ...
            it('fails when no input element', () => {
                const stringTemplates = {
                    string: (0, __1.StringTemplate)(dom_1.document, true)
                };
                const formatDecorator = (0, __1.FormatDecorator)(dom_1.document, stringTemplates);
                assert.throws(() => {
        ...
        describe('mutable-array-list', () => {
            ...
            templates.arrayList = (0, __1.MutableArrayListDecorator)(dom_1.document, dom_1.Event, (0, __1.ArrayListTemplate)(dom_1.document, templates), templates);
            templates.arrayItem = (0, __1.MutableArrayItemDecorator)(dom_1.document, (0, __1.ArrayItemTemplate)(dom_1.document, templates));
        ...
        describe('type', () => {
            it('decorates name with type', () => {
                const stringTemplate = (0, type_1.TypeDecorator)(dom_1.document, (0, __1.StringTemplate)(dom_1.document));
